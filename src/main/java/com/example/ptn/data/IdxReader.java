...
public class IdxReader {
   ...
   */
  private static List<LabeledImage> getLabeledImages(
    ...
    try (FileInputStream inImage = new FileInputStream(inputImagePath);
      ...
      for (int i = 0; i < amountOfDataSet; i++) {
        ...
        labeledImageArrayList
                .add(new LabeledImage(label, imgPixels));
      }
      LOGGER.info("Time to load LabeledImages in seconds: "
